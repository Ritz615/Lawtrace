...
import { Scale, Mail, Lock, User, Eye, EyeOff, ArrowRight, Briefcase } from "lucide-react";
...
const registerSchema = z
  .object({
    ...
    role: z.enum(["admin", "lawyer", "hr_manager", "business_user", "client"]),
  })
    ...
    <div className="min-h-screen gradient-mesh flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">Start managing contracts with AI</p>
        </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  {...register("role")}
                  className="w-full pl-10 pr-4 py-2.5 bg-secondary/50 border border-input rounded-xl text-sm
                             focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all appearance-none"
                >
                  {roles.map((r) => (
